...
# some corals got less dead from T1 to T2... double check these!
df %>%
...
### go back and check whether frags with mortality as NA are actually dead and should be 6...
...
# clearly some outlier values of weight to double check....
