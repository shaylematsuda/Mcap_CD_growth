...
#ggsave(fig2, filename = "output/figure2.tiff", width = 174, height = 90, units = "mm")
```
#growth Revisions.1 Just for reviewer (keep?)
Just Natural, Low and medium --> THIS does not have a significant 3-way. 
```{r}
grres.f.TOP2Shade<-grres.f
grres.f.TOP2Shade<-subset(grres.f.TOP2Shade, light.level=="Natural"|light.level=="Low Shade"|light.level=="Medium Shade")
