...
#### ROSS ####
#how to do pairwise comparing DLIs within a symbiont group AT each time point...
...
ggsave(fig2, filename = "output/figure2.svg", width = 174, height = 90, units = "mm")



# #add astrix - still not working
# ann_text <- data.frame(dli = 1.4,growth.rate = 4.5,lab = "*",
